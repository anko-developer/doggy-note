...
export default function ReportWritePage() {
  ...
  return (
    <div className="flex flex-col gap-6 p-4 pb-24">
      ...
      <section>
        <p className="mb-2 text-sm font-bold text-[#111111]">오늘 기분</p>
      ...
      <section>
        <p className="mb-2 text-sm font-bold text-[#111111]">식사 섭취량</p>
      ...
      <section>
        <p className="mb-2 text-sm font-bold text-[#111111]">산책</p>
      ...
      <section>
        <p className="mb-2 text-sm font-bold text-[#111111]">훈련</p>
        <TrainingLog entries={training} onChange={setTraining} />
      </section>

      <section>
        <p className="mb-2 text-sm font-bold text-[#111111]">선생님 한마디</p>
        <Textarea
          value={note}
      ...
      {isPublished && (
        <p className="text-center text-sm text-[#9E9EA0]">발송 완료 ✓</p>
      )}
    </div>
  );
}
